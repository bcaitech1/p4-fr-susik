...
default_checkpoint = {
    ...
    "validation_wer": [],
    "validation_competition_score" : [], #TODO
    "lr": [],
    "grad_norm": [],
    "model": {},
    "configs":{},
...
def write_tensorboard(
    ...
    writer.add_scalar("train_competition_score", train_competition_score, epoch) # TODO
    ...
    writer.add_scalar("validation_competition_score", validation_competition_score, epoch) #TODO
