...
def main(config_file):
    ...
    if model_checkpoint:
        print(
            ...
            "Train Competiton Score : {:.5f}\n".format(checkpoint["train_competition_score"][-1]), #TODO
            ...
            "Validation Competition Score : {:.5f}\n".format(checkpoint["validation_competition_score"][-1]), #TODO
    ...
    train_competition_score = checkpoint["train_competition_score"] #TODO
    ...
    validation_competition_score = checkpoint["validation_competition_score"] # TODO
    ...
    for epoch in range(options.num_epochs):
        ...
        train_competition_score.append(0.9 * train_epoch_sentence_accuracy + 0.1 * (1 - train_epoch_wer)) # TODO
        ...
        validation_competition_score.append(0.9 * validation_epoch_sentence_accuracy + 0.1 * (1 - validation_epoch_wer)) # TODO
        ...
        save_checkpoint(
            {
                "epoch": start_epoch + epoch + 1,
                "train_competition_score" : train_competition_score, # TODO
                ...
                "validation_competition_score" : validation_competition_score, #TODO
                "lr": learning_rates,
        ...
        if epoch % options.print_epochs == 0 or epoch == options.num_epochs - 1:
            output_string = (
                "{epoch_text}: "
                "Train Competition Score = {train_competition_score:.5f}, " #TODO
                ...
                "Validation Competition Score = {validation_competition_score:.5f}, " #TODO 
                ...
                train_competition_score=train_competition_score[-1], # TODO
                ...
                validation_competition_score=validation_competition_score[-1], #TODO
            ...
            write_tensorboard(
                ...
                validation_epoch_sentence_accuracy,
                validation_epoch_wer,
                train_competition_score[-1], # TODO
                validation_competition_score[-1], #TODO
                model,
            )
